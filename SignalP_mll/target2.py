...
from embedding_creator.probert_create_embedding import *
...
def createTrainTestData(data_path='./data/data_list.txt', label_path="./data/target_list.txt"
    ...
    features = np.concatenate((trans_data_msa_in_batches(raw_data), trans_data_pro_in_batches(raw_data)),axis=1)
...
def createTestData(data_path='./test_data/data_list.txt', label_path="./test_data/target_list.txt",
                   ...
                   test_path2="./pro_embedding/test_feature.npy"
                   ):
    # 初始化
    data_list = []
    label_list = []
    ...
    features = np.concatenate((trans_data_msa_in_batches(raw_data, path=test_path),
                               trans_data_pro_in_batches(raw_data, path=test_path2)), axis=1)
...
if __name__ == '__main__':
    ...
    lstm_config = {'dropout_rate': 0.2, 'input_dim': 32+4,
