...
def trans_data_pro(str_array):
    ...
    embedding = np.array(embedding)[:, 1:max_len+1, :]

    return embedding

def trans_data_pro_in_batches(str_array, split=100, path="./pro_embedding/train_full_feature.npy"):
...
if __name__ == '__main__':
    ...
    createDatasetEmbedding('../data/data_list.txt', "../pro_embedding/train_full_feature.npy")
    createDatasetEmbedding('../test_data/data_list.txt', "../pro_embedding/test_full_feature.npy")
